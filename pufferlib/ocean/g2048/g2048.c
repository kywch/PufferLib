...
int main() {
    ...
    // Weights* weights = load_weights("resources/g2048/g2048_weights.bin", 1004805);
    // Weights* weights = load_weights("puffer_g2048_weights.bin", 1004805);
    Weights* weights = load_weights("puffer_g2048_weights.bin", 3713541);
